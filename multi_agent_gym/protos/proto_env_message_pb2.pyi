...
class RequestInfo(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"observation",u"sub_env_info"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"observation",u"sub_env_info"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"observation",b"observation",u"sub_env_info",b"sub_env_info"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"observation",b"observation",u"sub_env_info",b"sub_env_info"]) -> None: ...
