...
class RequestInfo(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        ndarray : typing___Optional[NDArray] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> RequestInfo: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> RequestInfo: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"ndarray",u"sub_env_info"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"ndarray",u"sub_env_info"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"ndarray",b"ndarray",u"sub_env_info",b"sub_env_info"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"ndarray",b"ndarray",u"sub_env_info",b"sub_env_info"]) -> None: ...
